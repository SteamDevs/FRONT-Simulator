...
@Component({
  selector: 'app-register-morning',
  templateUrl: './register-morning.component.html',
  styleUrls: ['./register-morning.component.scss']
})
export class RegisterMorningComponent implements OnInit {
  latitude: Number;
  longitude: Number;
  zoom: Number;
  address: String;
